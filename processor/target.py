...
class target:
                ...
                "children": {
                    ...
                    "details_submodule": {
                        ...
                        "children": {
                            ...
                            "rawCurrent_processed": {
                                "type": "uiVariable",
                                "name": "rawCurrent_processed",
    ...
    #         return None
    #     delta = (lvl_prev - lvl_now) * (355/113)*((tank_diameter_cm/2)**2)/1000 #all in cm, divide 1000 to get L
    #     return delta
    ...
    def compute_output_levels(self, cmds_channel, state_channel):
        ...
        raw_reading_1 = None
        try:
            raw_reading_1 = state_obj['state']['children']['details_submodule']['children']['rawCurrent']['currentValue']
        except Exception as e:
